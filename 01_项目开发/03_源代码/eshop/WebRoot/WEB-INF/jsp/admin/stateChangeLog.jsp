	...
	<div class="mainbody module clearfix">
		...
		<div class="side">
			...
			<ul class="nav clearfix">
				...
				<li class="current"><span>订单日志</span></li>
			</ul>
		</div>
		<div class="main">
				...
				<table class="order-list-nav">
					<table class="attention-nav">
						<tr>
							...
							<td class="cell-2" style="width:183px;">订单编号</td>
							<!--                            <td class="cell-4">关注人气</td>-->
							<td class="cell-3" style="width:172px;">事件</td>
							<td class="cell-5" style="width:172px;">时间</td>
					...
					<div class="attention-box">
						...
						<s:iterator value="stateChangeLogList" >
							<li>
								<div class="attention-inner clearfix">
									<div class="infor" style="width:120px;">
										<s:property
								value="changeId" />
									</div>
									<div class="sales" style="width:183px;"><s:property
								value="orderId" /></div>
									<div class="time" style="width:172px;"><s:property
								value="event" /></div>
									<div class="time" style="width:172px;"><s:property
								value="changeTime" /></div>
